...
interface PatchableComponentsAfter {
  (
    component: "App",
    fn: (props: React.PropsWithChildren) => Array<React.JSX.Element | ReactNode>
  ): void;
  (
    ...
    ) => Array<React.JSX.Element | ReactNode>
  ): void;
  (
...
interface IScenePlayerProps extends React.PropsWithChildren {
  scene: Scene;
